...
public class CustomerBean {
    ...
    private void init() {
        ...
        this.categories.add(new SelectItem("IT", getCategoryLabel("IT")));
        this.categories.add(new SelectItem("GR", getCategoryLabel("GR")));
        this.categories.add(new SelectItem("AT", getCategoryLabel("AT")));
        this.categories.add(new SelectItem("MX", getCategoryLabel("MX")));
    }
    ...
    private String getCategoryLabel(String category) {
        FacesContext ctx = FacesContext.getCurrentInstance();
        return GuiUtil.getResourceText(ctx, "msgs", "category_" + category);
    }
