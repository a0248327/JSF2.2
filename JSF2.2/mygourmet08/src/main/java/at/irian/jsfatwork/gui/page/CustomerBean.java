...
public class CustomerBean {
    ...
    private void init() {
        ...
        SelectItem[] euItems = {
                new SelectItem("IT", getCategoryLabel("IT")),
                new SelectItem("GR", getCategoryLabel("GR")),
                new SelectItem("AT", getCategoryLabel("AT"))
        };
        SelectItemGroup euGroup = new SelectItemGroup(
                "Europe", null, false, euItems);
        this.categories.add(euGroup);
